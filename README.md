...
[Vert.x](https://github.com/eclipse/vert.x) ⭐ 14,683 | 🐛 227 | 🌐 Java | 📅 2026-09-05.
...
* [Vert.x Maven plugin](https://github.com/reactiverse/vertx-maven-plugin) ⭐ 81 | 🐛 7 | 🌐 Java | 📅 2026-09-04
...
* [Vert.x Web](https://github.com/vert-x3/vertx-web) ⭐ 1,150 | 🐛 156 | 🌐 Java | 📅 2026-09-02  <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Full featured web toolkit for Vert.x.
...
* [Vert.x Auth SQL](https://github.com/eclipse-vertx/vertx-auth) ⭐ 175 | 🐛 48 | 🌐 Java | 📅 2026-09-02  <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x authentication/authorisation based on the Vert.x SQL client and a relational database.

* [Vert.x Auth JWT](https://github.com/eclipse-vertx/vertx-auth/tree/master/vertx-auth-jwt) ⭐ 175 | 🐛 48 | 🌐 Java | 📅 2026-09-02  <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x Authorisation based on JSON Web Tokens.

* [Vert.x Auth htdigest](https://github.com/eclipse-vertx/vertx-auth/tree/master/vertx-auth-htdigest) ⭐ 175 | 🐛 48 | 🌐 Java | 📅 2026-09-02  <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x Authorisation/Authentication based on [Apache htdigest](https://httpd.apache.org/docs/2.4/programs/htdigest.html).

* [Vert.x Auth OAuth2](https://github.com/eclipse-vertx/vertx-auth/tree/master/vertx-auth-oauth2) ⭐ 175 | 🐛 48 | 🌐 Java | 📅 2026-09-02 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x Authorisation/Authentication based on [OAuth 2](https://oauth.net/2/).

* [Vert.x Auth htpasswd](https://github.com/eclipse-vertx/vertx-auth/tree/master/vertx-auth-htpasswd) ⭐ 175 | 🐛 48 | 🌐 Java | 📅 2026-09-02 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x Authorisation/Authentication based on [htpasswd](https://httpd.apache.org/docs/2.4/programs/htpasswd.html).

* [Vert.x-Pac4j](https://github.com/pac4j/vertx-pac4j) ⭐ 135 | 🐛 2 | 🌐 Java | 📅 2026-09-05 - Vert.x authentication/authorisation implemented using [pac4j](http://www.pac4j.org/).
...
* Relational Databases
  ...
  * [Exposed Vert.x SQL Client](https://github.com/huanshankeji/exposed-vertx-sql-client) ⭐ 10 | 🐛 16 | 🌐 Kotlin | 📅 2026-07-25 - Kotlin's [Exposed](https://github.com/JetBrains/Exposed) ⭐ 9,284 | 🐛 168 | 🌐 Kotlin | 📅 2026-09-04 on top of [Vert.x Reactive SQL Client](https://github.com/eclipse-vertx/vertx-sql-client) ⭐ 913 | 🐛 78 | 🌐 Java | 📅 2026-09-01.

* NoSQL Databases
  * [SirixDB](https://github.com/sirixdb/sirix/tree/master/bundles/sirix-rest-api) ⭐ 1,217 | 🐛 9 | 🌐 Java | 📅 2026-09-04 - Non-blocking SirixDB HTTP-server.
  * [Redis](https://github.com/vert-x3/vertx-redis-client) ⭐ 142 | 🐛 26 | 🌐 Java | 📅 2026-09-01 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Asynchronous API to interact with Redis.
  ...
  * [Aerospike](https://github.com/dream11/vertx-aerospike-client) ⭐ 32 | 🐛 3 | 🌐 Java | 📅 2025-12-22 - Asynchronous and non-blocking API to interact with Aerospike server. Uses [AerospikeClient's](https://github.com/aerospike/aerospike-client-java) ⭐ 248 | 🐛 26 | 🌐 Java | 📅 2026-09-05 async commands internally and handles the result on the Vert.x Context.
...
* Messaging
  * [AMQP 1.0 - Kafka bridge](https://github.com/rhiot/amqp-kafka-bridge) ⭐ 339 | 🐛 15 | 🌐 Java | 📅 2026-09-02 - Bridge for sending/receiving messages to/from Apache Kafka using the AMQP 1.0 protocol.
  ...
  * [The White Rabbit](https://github.com/viartemev/the-white-rabbit) ⭐ 130 | 🐛 13 | 🌐 Kotlin | 📅 2026-08-25 - An asynchronous RabbitMQ (AMQP) client based on Kotlin coroutines.
...
* Netflix - Hystrix
  * [Hystrix Metrics Stream](https://github.com/kennedyoliveira/hystrix-vertx-metrics-stream.git) ⭐ 15 | 🐛 2 | 🌐 Java | 📅 2016-10-03 - Emits metrics for Hystrix Dashboard from a Vert.x application with [Hystrix](https://github.com/Netflix/Hystrix) ⭐ 24,473 | 🐛 58 | 🌐 Java | 📅 2025-12-17.
...
* [Gateleen](https://github.com/swisspush/gateleen) ⭐ 84 | 🐛 48 | 🌐 Java | 📅 2026-09-02 - Middleware library based on Vert.x to build advanced JSON/REST communication servers.
...
* [Java](https://github.com/eclipse/vert.x) ⭐ 14,683 | 🐛 227 | 🌐 Java | 📅 2026-09-05 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x main repository (including the Java API).
...
* [Go](https://github.com/jponge/vertx-go-tcp-eventbus-bridge) ⭐ 31 | 🐛 0 | 🌐 Go | 📅 2018-03-15- Event bus client for Go-lang using the [TCP-based protocol](https://github.com/vert-x3/vertx-tcp-eventbus-bridge) ⭐ 54 | 🐛 10 | 🌐 Java | 📅 2026-09-01.
...
* [Eventbus Service](https://github.com/wowselim/eventbus-service) ⭐ 14 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-05 - Code generator for type-safe event bus communication via simple Kotlin interfaces.
...
* [Resilience4j](https://github.com/resilience4j/resilience4j) ⭐ 10,756 | 🐛 300 | 🌐 Java | 📅 2026-08-31 - Resilience4j is a fault tolerance library designed for Java8 and functional programming. Resilience4j provides modules for Circuit Breaking, Rate Limiting, Bulkheading, Automatic retrying, Response caching and Metric measuring.
* [Failsafe](https://failsafe.dev/) - Failsafe is a lightweight, *zero-dependency* library for handling failures in Java 8+. Concise API. Integration with libraries that use their own schedulers for async executions, such as Akka or Vert.x. [Vert.x example](https://github.com/failsafe-lib/failsafe/blob/master/examples/src/main/java/dev/failsafe/examples/VertxExample.java) ⭐ 4,310 | 🐛 78 | 🌐 Java | 📅 2025-12-28
...
* [openapi-generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,726 | 🐛 5,745 | 🌐 Java | 📅 2026-09-04 - OpenAPI Generator allows generation of API client libraries (SDK generation), server stubs, documentation and configuration automatically given an OpenAPI Spec (v2, v3).
...
* [vertx-redisques](https://github.com/swisspush/vertx-redisques) ⭐ 14 | 🐛 20 | 🌐 Java | 📅 2026-09-03 - A highly scalable redis-persistent queuing system for Vert.x.
...
* [Knative](https://github.com/knative/docs/tree/main/code-samples/community/serving/helloworld-vertx) ⭐ 5,085 | 🐛 47 | 🌐 HTML | 📅 2026-09-03 - An example application on how to use [Reactive Extensions Vert.x](https://github.com/vert-x3/vertx-rx) ⭐ 154 | 🐛 5 | 🌐 Java | 📅 2026-09-01 with [Knative](https://github.com/knative).
...
* [Contextual logging](https://github.com/reactiverse/reactiverse-contextual-logging) ⭐ 41 | 🐛 0 | 🌐 HTML | 📅 2026-09-04 - Mapped Diagnostic Context (MDC) that works with the Vert.x event-loop model.
