...
[Vert.x](https://github.com/eclipse/vert.x) ⭐ 14,687 | 🐛 230 | 🌐 Java | 📅 2026-08-28.
...
* Relational Databases
  ...
  * [Exposed Vert.x SQL Client](https://github.com/huanshankeji/exposed-vertx-sql-client) ⭐ 10 | 🐛 16 | 🌐 Kotlin | 📅 2026-07-25 - Kotlin's [Exposed](https://github.com/JetBrains/Exposed) ⭐ 9,280 | 🐛 162 | 🌐 Kotlin | 📅 2026-08-28 on top of [Vert.x Reactive SQL Client](https://github.com/eclipse-vertx/vertx-sql-client) ⭐ 913 | 🐛 75 | 🌐 Java | 📅 2026-08-27.

* NoSQL Databases
  * [SirixDB](https://github.com/sirixdb/sirix/tree/master/bundles/sirix-rest-api) ⭐ 1,216 | 🐛 4 | 🌐 Java | 📅 2026-08-27 - Non-blocking SirixDB HTTP-server.
...
* [Java](https://github.com/eclipse/vert.x) ⭐ 14,687 | 🐛 230 | 🌐 Java | 📅 2026-08-28 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x main repository (including the Java API).
...
* [Eventbus Service](https://github.com/wowselim/eventbus-service) ⭐ 14 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-27 - Code generator for type-safe event bus communication via simple Kotlin interfaces.
...
* [openapi-generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,708 | 🐛 5,718 | 🌐 Java | 📅 2026-08-31 - OpenAPI Generator allows generation of API client libraries (SDK generation), server stubs, documentation and configuration automatically given an OpenAPI Spec (v2, v3).
...
* [Knative](https://github.com/knative/docs/tree/main/code-samples/community/serving/helloworld-vertx) ⭐ 5,082 | 🐛 42 | 🌐 HTML | 📅 2026-08-24 - An example application on how to use [Reactive Extensions Vert.x](https://github.com/vert-x3/vertx-rx) ⭐ 154 | 🐛 5 | 🌐 Java | 📅 2026-08-07 with [Knative](https://github.com/knative).
