...
[Vert.x](https://github.com/eclipse/vert.x) ⭐ 14,685 | 🐛 221 | 🌐 Java | 📅 2026-09-15.
...
* [Vert.x Web](https://github.com/vert-x3/vertx-web) ⭐ 1,150 | 🐛 150 | 🌐 Java | 📅 2026-09-14  <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Full featured web toolkit for Vert.x.
...
* [vertx-rest-storage](https://github.com/swisspush/vertx-rest-storage) ⭐ 19 | 🐛 19 | 🌐 Java | 📅 2026-09-15 - Persistence for REST resources in the filesystem or a redis database.
...
* [Vert.x Auth SQL](https://github.com/eclipse-vertx/vertx-auth) ⭐ 175 | 🐛 44 | 🌐 Java | 📅 2026-09-15  <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x authentication/authorisation based on the Vert.x SQL client and a relational database.

* [Vert.x Auth JWT](https://github.com/eclipse-vertx/vertx-auth/tree/master/vertx-auth-jwt) ⭐ 175 | 🐛 44 | 🌐 Java | 📅 2026-09-15  <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x Authorisation based on JSON Web Tokens.

* [Vert.x Auth htdigest](https://github.com/eclipse-vertx/vertx-auth/tree/master/vertx-auth-htdigest) ⭐ 175 | 🐛 44 | 🌐 Java | 📅 2026-09-15  <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x Authorisation/Authentication based on [Apache htdigest](https://httpd.apache.org/docs/2.4/programs/htdigest.html).

* [Vert.x Auth OAuth2](https://github.com/eclipse-vertx/vertx-auth/tree/master/vertx-auth-oauth2) ⭐ 175 | 🐛 44 | 🌐 Java | 📅 2026-09-15 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x Authorisation/Authentication based on [OAuth 2](https://oauth.net/2/).

* [Vert.x Auth htpasswd](https://github.com/eclipse-vertx/vertx-auth/tree/master/vertx-auth-htpasswd) ⭐ 175 | 🐛 44 | 🌐 Java | 📅 2026-09-15 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x Authorisation/Authentication based on [htpasswd](https://httpd.apache.org/docs/2.4/programs/htpasswd.html).
...
* Relational Databases
  * [Reactive SQL Client](https://github.com/eclipse-vertx/vertx-sql-client) ⭐ 911 | 🐛 77 | 🌐 Java | 📅 2026-09-14 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - High performance reactive SQL client.
  ...
  * [Exposed Vert.x SQL Client](https://github.com/huanshankeji/exposed-vertx-sql-client) ⭐ 11 | 🐛 16 | 🌐 Kotlin | 📅 2026-09-11 - Kotlin's [Exposed](https://github.com/JetBrains/Exposed) ⭐ 9,288 | 🐛 172 | 🌐 Kotlin | 📅 2026-09-15 on top of [Vert.x Reactive SQL Client](https://github.com/eclipse-vertx/vertx-sql-client) ⭐ 911 | 🐛 77 | 🌐 Java | 📅 2026-09-14.
...
* NoSQL Databases
  ...
  * [Redis](https://github.com/vert-x3/vertx-redis-client) ⭐ 142 | 🐛 26 | 🌐 Java | 📅 2026-09-14 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Asynchronous API to interact with Redis.
  ...
  * [Aerospike](https://github.com/dream11/vertx-aerospike-client) ⭐ 32 | 🐛 3 | 🌐 Java | 📅 2025-12-22 - Asynchronous and non-blocking API to interact with Aerospike server. Uses [AerospikeClient's](https://github.com/aerospike/aerospike-client-java) ⭐ 248 | 🐛 23 | 🌐 Java | 📅 2026-09-15 async commands internally and handles the result on the Vert.x Context.
  ...
  * [Neo4j Java Driver Vert.x](https://github.com/romanbsd/neo4j-java-driver-vertx) ⭐ 0 | 🐛 0 | 🌐 Java | 📅 2026-09-13 - Vert.x wrapper around the Neo4j Java Driver.
...
* CNCF CloudEvents
  * [CloudEvents.io Java SDK](https://github.com/cloudevents/sdk-java) ⭐ 446 | 🐛 78 | 🌐 Java | 📅 2026-07-16 - Send and receive [CloudEvents](https://cloudevents.io/) using the [Vert.x HTTP Transport](https://github.com/cloudevents/sdk-java/blob/master/http/vertx/README.md) ⭐ 446 | 🐛 78 | 🌐 Java | 📅 2026-07-16 for CloudEvents.

## Middleware

* [Gateleen](https://github.com/swisspush/gateleen) ⭐ 84 | 🐛 46 | 🌐 Java | 📅 2026-09-15 - Middleware library based on Vert.x to build advanced JSON/REST communication servers.
...
* [Java](https://github.com/eclipse/vert.x) ⭐ 14,685 | 🐛 221 | 🌐 Java | 📅 2026-09-15 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x main repository (including the Java API).
...
* [Eventbus Service](https://github.com/wowselim/eventbus-service) ⭐ 14 | 🐛 1 | 🌐 Kotlin | 📅 2026-09-14 - Code generator for type-safe event bus communication via simple Kotlin interfaces.
...
* [Resilience4j](https://github.com/resilience4j/resilience4j) ⭐ 10,760 | 🐛 306 | 🌐 Java | 📅 2026-08-31 - Resilience4j is a fault tolerance library designed for Java8 and functional programming. Resilience4j provides modules for Circuit Breaking, Rate Limiting, Bulkheading, Automatic retrying, Response caching and Metric measuring.
* [Failsafe](https://failsafe.dev/) - Failsafe is a lightweight, *zero-dependency* library for handling failures in Java 8+. Concise API. Integration with libraries that use their own schedulers for async executions, such as Akka or Vert.x. [Vert.x example](https://github.com/failsafe-lib/failsafe/blob/master/examples/src/main/java/dev/failsafe/examples/VertxExample.java) ⭐ 4,313 | 🐛 78 | 🌐 Java | 📅 2025-12-28
...
* [openapi-generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,740 | 🐛 5,748 | 🌐 Java | 📅 2026-09-15 - OpenAPI Generator allows generation of API client libraries (SDK generation), server stubs, documentation and configuration automatically given an OpenAPI Spec (v2, v3).
...
* [vertx-redisques](https://github.com/swisspush/vertx-redisques) ⭐ 14 | 🐛 19 | 🌐 Java | 📅 2026-09-15 - A highly scalable redis-persistent queuing system for Vert.x.
...
* [Contextual logging](https://github.com/reactiverse/reactiverse-contextual-logging) ⭐ 41 | 🐛 0 | 🌐 HTML | 📅 2026-09-14 - Mapped Diagnostic Context (MDC) that works with the Vert.x event-loop model.
