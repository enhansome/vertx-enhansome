...
[Vert.x](https://github.com/eclipse/vert.x) ⭐ 14,685 | 🐛 228 | 🌐 Java | 📅 2026-08-31.
...
* [Vert.x Web](https://github.com/vert-x3/vertx-web) ⭐ 1,150 | 🐛 156 | 🌐 Java | 📅 2026-08-28  <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Full featured web toolkit for Vert.x.
...
* [Vert.x Auth SQL](https://github.com/eclipse-vertx/vertx-auth) ⭐ 175 | 🐛 48 | 🌐 Java | 📅 2026-08-25  <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x authentication/authorisation based on the Vert.x SQL client and a relational database.

* [Vert.x Auth JWT](https://github.com/eclipse-vertx/vertx-auth/tree/master/vertx-auth-jwt) ⭐ 175 | 🐛 48 | 🌐 Java | 📅 2026-08-25  <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x Authorisation based on JSON Web Tokens.

* [Vert.x Auth htdigest](https://github.com/eclipse-vertx/vertx-auth/tree/master/vertx-auth-htdigest) ⭐ 175 | 🐛 48 | 🌐 Java | 📅 2026-08-25  <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x Authorisation/Authentication based on [Apache htdigest](https://httpd.apache.org/docs/2.4/programs/htdigest.html).

* [Vert.x Auth OAuth2](https://github.com/eclipse-vertx/vertx-auth/tree/master/vertx-auth-oauth2) ⭐ 175 | 🐛 48 | 🌐 Java | 📅 2026-08-25 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x Authorisation/Authentication based on [OAuth 2](https://oauth.net/2/).

* [Vert.x Auth htpasswd](https://github.com/eclipse-vertx/vertx-auth/tree/master/vertx-auth-htpasswd) ⭐ 175 | 🐛 48 | 🌐 Java | 📅 2026-08-25 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x Authorisation/Authentication based on [htpasswd](https://httpd.apache.org/docs/2.4/programs/htpasswd.html).

* [Vert.x-Pac4j](https://github.com/pac4j/vertx-pac4j) ⭐ 135 | 🐛 2 | 🌐 Java | 📅 2026-08-26 - Vert.x authentication/authorisation implemented using [pac4j](http://www.pac4j.org/).
...
* Relational Databases
  * [Reactive SQL Client](https://github.com/eclipse-vertx/vertx-sql-client) ⭐ 913 | 🐛 75 | 🌐 Java | 📅 2026-08-27 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - High performance reactive SQL client.
  ...
  * [JDBC](https://github.com/vert-x3/vertx-jdbc-client) ⭐ 131 | 🐛 32 | 🌐 Java | 📅 2026-08-28 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Asynchronous interface around a JDBC datasource.
  ...
  * [Exposed Vert.x SQL Client](https://github.com/huanshankeji/exposed-vertx-sql-client) ⭐ 10 | 🐛 16 | 🌐 Kotlin | 📅 2026-07-25 - Kotlin's [Exposed](https://github.com/JetBrains/Exposed) ⭐ 9,281 | 🐛 166 | 🌐 Kotlin | 📅 2026-08-31 on top of [Vert.x Reactive SQL Client](https://github.com/eclipse-vertx/vertx-sql-client) ⭐ 913 | 🐛 75 | 🌐 Java | 📅 2026-08-27.

* NoSQL Databases
  * [SirixDB](https://github.com/sirixdb/sirix/tree/master/bundles/sirix-rest-api) ⭐ 1,216 | 🐛 7 | 🌐 Java | 📅 2026-08-31 - Non-blocking SirixDB HTTP-server.
  * [Redis](https://github.com/vert-x3/vertx-redis-client) ⭐ 142 | 🐛 27 | 🌐 Java | 📅 2026-08-25 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Asynchronous API to interact with Redis.
  ...
  * [Aerospike](https://github.com/dream11/vertx-aerospike-client) ⭐ 32 | 🐛 3 | 🌐 Java | 📅 2025-12-22 - Asynchronous and non-blocking API to interact with Aerospike server. Uses [AerospikeClient's](https://github.com/aerospike/aerospike-client-java) ⭐ 248 | 🐛 20 | 🌐 Java | 📅 2026-08-31 async commands internally and handles the result on the Vert.x Context.
...
* Messaging
  * [AMQP 1.0 - Kafka bridge](https://github.com/rhiot/amqp-kafka-bridge) ⭐ 339 | 🐛 14 | 🌐 Java | 📅 2026-08-30 - Bridge for sending/receiving messages to/from Apache Kafka using the AMQP 1.0 protocol.
  ...
  * [STOMP](https://github.com/vert-x3/vertx-stomp) ⭐ 35 | 🐛 22 | 🌐 Java | 📅 2026-08-07 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - A Kafka client and server.
...
* Metrics
  * [Micrometer metrics](https://github.com/vert-x3/vertx-micrometer-metrics) ⭐ 55 | 🐛 1 | 🌐 Java | 📅 2026-08-24 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Metrics implementation using Micrometer metrics.
...
* [Gateleen](https://github.com/swisspush/gateleen) ⭐ 84 | 🐛 48 | 🌐 Java | 📅 2026-08-27 - Middleware library based on Vert.x to build advanced JSON/REST communication servers.
...
* [Java](https://github.com/eclipse/vert.x) ⭐ 14,685 | 🐛 228 | 🌐 Java | 📅 2026-08-31 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x main repository (including the Java API).
...
* [Vert.x Rx](https://github.com/vert-x3/vertx-rx) ⭐ 154 | 🐛 5 | 🌐 Java | 📅 2026-08-07 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x Reactive Extensions.
...
* [Hazelcast Cluster Manager](https://github.com/vert-x3/vertx-hazelcast) ⭐ 82 | 🐛 2 | 🌐 Java | 📅 2026-08-26 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Hazelcast cluster manager.
...
* [Circuit Breaker](https://github.com/vert-x3/vertx-circuit-breaker) ⭐ 67 | 🐛 7 | 🌐 Java | 📅 2026-08-13 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Circuit Breaker" height="16px"> - Vert.x Circuit Breaker.
...
* [Vert.x JUnit5](https://github.com/vert-x3/vertx-junit5) ⭐ 43 | 🐛 11 | 🌐 Java | 📅 2026-08-24 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Async unit testing for Vert.x with junit5.
...
* [openapi-generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,711 | 🐛 5,718 | 🌐 Java | 📅 2026-09-01 - OpenAPI Generator allows generation of API client libraries (SDK generation), server stubs, documentation and configuration automatically given an OpenAPI Spec (v2, v3).
...
* [Knative](https://github.com/knative/docs/tree/main/code-samples/community/serving/helloworld-vertx) ⭐ 5,082 | 🐛 42 | 🌐 HTML | 📅 2026-09-01 - An example application on how to use [Reactive Extensions Vert.x](https://github.com/vert-x3/vertx-rx) ⭐ 154 | 🐛 5 | 🌐 Java | 📅 2026-08-07 with [Knative](https://github.com/knative).
...
* [Vert.x Markdown service](https://github.com/aesteve/vertx-markdown-service) ⭐ 6 | 🐛 1 | 🌐 Java | 📅 2015-11-15 - Example on how to use [service-proxy](https://github.com/vert-x3/vertx-service-proxy) ⭐ 70 | 🐛 18 | 🌐 Java | 📅 2026-08-25 with Gradle.
