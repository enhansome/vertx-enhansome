...
* [Vert.x Maven plugin](https://github.com/reactiverse/vertx-maven-plugin) ⭐ 81 | 🐛 10 | 🌐 Java | 📅 2026-09-21
...
* [vertx-rest-storage](https://github.com/swisspush/vertx-rest-storage) ⭐ 20 | 🐛 19 | 🌐 Java | 📅 2026-09-15 - Persistence for REST resources in the filesystem or a redis database.
...
* Relational Databases
  * [Reactive SQL Client](https://github.com/eclipse-vertx/vertx-sql-client) ⭐ 912 | 🐛 76 | 🌐 Java | 📅 2026-09-18 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - High performance reactive SQL client.
  ...
  * [Exposed Vert.x SQL Client](https://github.com/huanshankeji/exposed-vertx-sql-client) ⭐ 11 | 🐛 16 | 🌐 Kotlin | 📅 2026-09-11 - Kotlin's [Exposed](https://github.com/JetBrains/Exposed) ⭐ 9,289 | 🐛 167 | 🌐 Kotlin | 📅 2026-09-21 on top of [Vert.x Reactive SQL Client](https://github.com/eclipse-vertx/vertx-sql-client) ⭐ 912 | 🐛 76 | 🌐 Java | 📅 2026-09-18.

* NoSQL Databases
  * [SirixDB](https://github.com/sirixdb/sirix/tree/master/bundles/sirix-rest-api) ⭐ 1,218 | 🐛 5 | 🌐 Java | 📅 2026-09-21 - Non-blocking SirixDB HTTP-server.
  ...
  * [Aerospike](https://github.com/dream11/vertx-aerospike-client) ⭐ 32 | 🐛 3 | 🌐 Java | 📅 2025-12-22 - Asynchronous and non-blocking API to interact with Aerospike server. Uses [AerospikeClient's](https://github.com/aerospike/aerospike-client-java) ⭐ 248 | 🐛 27 | 🌐 Java | 📅 2026-09-20 async commands internally and handles the result on the Vert.x Context.
...
* Messaging
  * [AMQP 1.0 - Kafka bridge](https://github.com/rhiot/amqp-kafka-bridge) ⭐ 341 | 🐛 14 | 🌐 Java | 📅 2026-09-20 - Bridge for sending/receiving messages to/from Apache Kafka using the AMQP 1.0 protocol.
...
* [Gateleen](https://github.com/swisspush/gateleen) ⭐ 84 | 🐛 42 | 🌐 Java | 📅 2026-09-21 - Middleware library based on Vert.x to build advanced JSON/REST communication servers.
...
* [openapi-generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,751 | 🐛 5,741 | 🌐 Java | 📅 2026-09-21 - OpenAPI Generator allows generation of API client libraries (SDK generation), server stubs, documentation and configuration automatically given an OpenAPI Spec (v2, v3).
...
* [vertx-redisques](https://github.com/swisspush/vertx-redisques) ⭐ 15 | 🐛 19 | 🌐 Java | 📅 2026-09-15 - A highly scalable redis-persistent queuing system for Vert.x.
