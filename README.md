...
* [Vert.x-Pac4j](https://github.com/pac4j/vertx-pac4j) ⭐ 135 | 🐛 2 | 🌐 Java | 📅 2026-08-20 - Vert.x authentication/authorisation implemented using [pac4j](http://www.pac4j.org/).
...
* NoSQL Databases
  * [SirixDB](https://github.com/sirixdb/sirix/tree/master/bundles/sirix-rest-api) ⭐ 1,215 | 🐛 10 | 🌐 Java | 📅 2026-08-24 - Non-blocking SirixDB HTTP-server.
  ...
  * [Aerospike](https://github.com/dream11/vertx-aerospike-client) ⭐ 32 | 🐛 3 | 🌐 Java | 📅 2025-12-22 - Asynchronous and non-blocking API to interact with Aerospike server. Uses [AerospikeClient's](https://github.com/aerospike/aerospike-client-java) ⭐ 248 | 🐛 21 | 🌐 Java | 📅 2026-08-23 async commands internally and handles the result on the Vert.x Context.
...
* [Knative](https://github.com/knative/docs/tree/main/code-samples/community/serving/helloworld-vertx) ⭐ 5,081 | 🐛 41 | 🌐 HTML | 📅 2026-08-19 - An example application on how to use [Reactive Extensions Vert.x](https://github.com/vert-x3/vertx-rx) ⭐ 155 | 🐛 5 | 🌐 Java | 📅 2026-08-07 with [Knative](https://github.com/knative).
