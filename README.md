...
[Vert.x](https://github.com/eclipse/vert.x) ⭐ 14,691 | 🐛 221 | 🌐 Java | 📅 2026-09-18.
...
* [Vert.x Maven plugin](https://github.com/reactiverse/vertx-maven-plugin) ⭐ 81 | 🐛 8 | 🌐 Java | 📅 2026-09-25
...
* [Vert.x Web](https://github.com/vert-x3/vertx-web) ⭐ 1,149 | 🐛 152 | 🌐 Java | 📅 2026-09-18  <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Full featured web toolkit for Vert.x.
...
* [vertx-rest-storage](https://github.com/swisspush/vertx-rest-storage) ⭐ 21 | 🐛 20 | 🌐 Java | 📅 2026-09-22 - Persistence for REST resources in the filesystem or a redis database.
...
* Relational Databases
  * [Reactive SQL Client](https://github.com/eclipse-vertx/vertx-sql-client) ⭐ 912 | 🐛 78 | 🌐 Java | 📅 2026-09-24 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - High performance reactive SQL client.
  ...
  * [Exposed Vert.x SQL Client](https://github.com/huanshankeji/exposed-vertx-sql-client) ⭐ 11 | 🐛 16 | 🌐 Kotlin | 📅 2026-09-25 - Kotlin's [Exposed](https://github.com/JetBrains/Exposed) ⭐ 9,290 | 🐛 171 | 🌐 Kotlin | 📅 2026-09-24 on top of [Vert.x Reactive SQL Client](https://github.com/eclipse-vertx/vertx-sql-client) ⭐ 912 | 🐛 78 | 🌐 Java | 📅 2026-09-24.

* NoSQL Databases
  * [SirixDB](https://github.com/sirixdb/sirix/tree/master/bundles/sirix-rest-api) ⭐ 1,219 | 🐛 3 | 🌐 Java | 📅 2026-09-23 - Non-blocking SirixDB HTTP-server.
  ...
  * [Aerospike](https://github.com/dream11/vertx-aerospike-client) ⭐ 32 | 🐛 3 | 🌐 Java | 📅 2025-12-22 - Asynchronous and non-blocking API to interact with Aerospike server. Uses [AerospikeClient's](https://github.com/aerospike/aerospike-client-java) ⭐ 248 | 🐛 29 | 🌐 Java | 📅 2026-09-24 async commands internally and handles the result on the Vert.x Context.
...
* Netflix - Hystrix
  * [Hystrix Metrics Stream](https://github.com/kennedyoliveira/hystrix-vertx-metrics-stream.git) ⭐ 15 | 🐛 2 | 🌐 Java | 📅 2016-10-03 - Emits metrics for Hystrix Dashboard from a Vert.x application with [Hystrix](https://github.com/Netflix/Hystrix) ⭐ 24,488 | 🐛 58 | 🌐 Java | 📅 2025-12-17.
...
* [Gateleen](https://github.com/swisspush/gateleen) ⭐ 84 | 🐛 41 | 🌐 Java | 📅 2026-09-23 - Middleware library based on Vert.x to build advanced JSON/REST communication servers.
...
* [Java](https://github.com/eclipse/vert.x) ⭐ 14,691 | 🐛 221 | 🌐 Java | 📅 2026-09-18 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x main repository (including the Java API).
...
* [openapi-generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,760 | 🐛 5,738 | 🌐 Java | 📅 2026-09-25 - OpenAPI Generator allows generation of API client libraries (SDK generation), server stubs, documentation and configuration automatically given an OpenAPI Spec (v2, v3).
...
* [Simple File Server](https://github.com/pitchpoint-solutions/sfs) ⭐ 89 | 🐛 8 | 🌐 Java | 📅 2022-10-04 - An OpenStack Swift compatible distributed object storage server that can serve and securely store billions of large and small files using minimal resources implemented using Vert.x.
...
* [vertx-redisques](https://github.com/swisspush/vertx-redisques) ⭐ 16 | 🐛 20 | 🌐 Java | 📅 2026-09-23 - A highly scalable redis-persistent queuing system for Vert.x.
...
* [Knative](https://github.com/knative/docs/tree/main/code-samples/community/serving/helloworld-vertx) ⭐ 5,093 | 🐛 56 | 🌐 HTML | 📅 2026-09-10 - An example application on how to use [Reactive Extensions Vert.x](https://github.com/vert-x3/vertx-rx) ⭐ 154 | 🐛 5 | 🌐 Java | 📅 2026-09-18 with [Knative](https://github.com/knative).
...
* [Contextual logging](https://github.com/reactiverse/reactiverse-contextual-logging) ⭐ 41 | 🐛 0 | 🌐 HTML | 📅 2026-09-22 - Mapped Diagnostic Context (MDC) that works with the Vert.x event-loop model.
...
* [Vert.x Scheduler](https://github.com/zero88/vertx-scheduler) ⭐ 14 | 🐛 24 | 🌐 Java | 📅 2026-09-24 - A lightweight plugable scheduler based on plain Vert.x core without any external libs for scheduling with *cron-style* and *interval* timers with a detail *monitor* on both sync and async task.
