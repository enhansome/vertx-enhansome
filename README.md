...
[Vert.x](https://github.com/eclipse/vert.x) ⭐ 14,685 | 🐛 228 | 🌐 Java | 📅 2026-09-01.
...
* [Vert.x Maven plugin](https://github.com/reactiverse/vertx-maven-plugin) ⭐ 81 | 🐛 8 | 🌐 Java | 📅 2026-08-31
...
* [Vert.x Web](https://github.com/vert-x3/vertx-web) ⭐ 1,150 | 🐛 156 | 🌐 Java | 📅 2026-09-01  <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Full featured web toolkit for Vert.x.
...
* [Vert.x Auth SQL](https://github.com/eclipse-vertx/vertx-auth) ⭐ 175 | 🐛 48 | 🌐 Java | 📅 2026-09-01  <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x authentication/authorisation based on the Vert.x SQL client and a relational database.

* [Vert.x Auth JWT](https://github.com/eclipse-vertx/vertx-auth/tree/master/vertx-auth-jwt) ⭐ 175 | 🐛 48 | 🌐 Java | 📅 2026-09-01  <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x Authorisation based on JSON Web Tokens.

* [Vert.x Auth htdigest](https://github.com/eclipse-vertx/vertx-auth/tree/master/vertx-auth-htdigest) ⭐ 175 | 🐛 48 | 🌐 Java | 📅 2026-09-01  <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x Authorisation/Authentication based on [Apache htdigest](https://httpd.apache.org/docs/2.4/programs/htdigest.html).

* [Vert.x Auth OAuth2](https://github.com/eclipse-vertx/vertx-auth/tree/master/vertx-auth-oauth2) ⭐ 175 | 🐛 48 | 🌐 Java | 📅 2026-09-01 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x Authorisation/Authentication based on [OAuth 2](https://oauth.net/2/).

* [Vert.x Auth htpasswd](https://github.com/eclipse-vertx/vertx-auth/tree/master/vertx-auth-htpasswd) ⭐ 175 | 🐛 48 | 🌐 Java | 📅 2026-09-01 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x Authorisation/Authentication based on [htpasswd](https://httpd.apache.org/docs/2.4/programs/htpasswd.html).

* [Vert.x-Pac4j](https://github.com/pac4j/vertx-pac4j) ⭐ 135 | 🐛 2 | 🌐 Java | 📅 2026-09-02 - Vert.x authentication/authorisation implemented using [pac4j](http://www.pac4j.org/).
...
* Relational Databases
  * [Reactive SQL Client](https://github.com/eclipse-vertx/vertx-sql-client) ⭐ 913 | 🐛 75 | 🌐 Java | 📅 2026-09-01 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - High performance reactive SQL client.
  ...
  * [jOOQx](https://github.com/zero88/jooqx) ⭐ 34 | 🐛 33 | 🌐 Java | 📅 2026-09-01 - Leverages the power of typesafe SQL from `jOOQ DSL` and uses the reactive and non-blocking SQL driver from Vert.x.
  * [Exposed Vert.x SQL Client](https://github.com/huanshankeji/exposed-vertx-sql-client) ⭐ 10 | 🐛 16 | 🌐 Kotlin | 📅 2026-07-25 - Kotlin's [Exposed](https://github.com/JetBrains/Exposed) ⭐ 9,283 | 🐛 166 | 🌐 Kotlin | 📅 2026-09-01 on top of [Vert.x Reactive SQL Client](https://github.com/eclipse-vertx/vertx-sql-client) ⭐ 913 | 🐛 75 | 🌐 Java | 📅 2026-09-01.

* NoSQL Databases
  * [SirixDB](https://github.com/sirixdb/sirix/tree/master/bundles/sirix-rest-api) ⭐ 1,216 | 🐛 7 | 🌐 Java | 📅 2026-09-01 - Non-blocking SirixDB HTTP-server.
  ...
  * [Cassandra](https://github.com/vert-x3/vertx-cassandra-client) ⭐ 35 | 🐛 3 | 🌐 Java | 📅 2026-09-01 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - A Vert.x client allowing applications to interact with a Cassandra service.
  * [Aerospike](https://github.com/dream11/vertx-aerospike-client) ⭐ 32 | 🐛 3 | 🌐 Java | 📅 2025-12-22 - Asynchronous and non-blocking API to interact with Aerospike server. Uses [AerospikeClient's](https://github.com/aerospike/aerospike-client-java) ⭐ 248 | 🐛 20 | 🌐 Java | 📅 2026-09-01 async commands internally and handles the result on the Vert.x Context.
...
* Mail
  * [SMTP](https://github.com/vert-x3/vertx-mail-client) ⭐ 40 | 🐛 15 | 🌐 Java | 📅 2026-09-01 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Async SMTP client.
...
* Messaging
  ...
  * [RabbitMQ](https://github.com/vert-x3/vertx-rabbitmq-client) ⭐ 76 | 🐛 16 | 🌐 Java | 📅 2026-09-01 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - A RabbitMQ client (AMQP 0.9.1).
...
* Metrics
  ...
  * [DropWizard metrics](https://github.com/vert-x3/vertx-dropwizard-metrics) ⭐ 35 | 🐛 7 | 🌐 Java | 📅 2026-09-01 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Metrics implementation using DropWizard metrics.
...
* [Java](https://github.com/eclipse/vert.x) ⭐ 14,685 | 🐛 228 | 🌐 Java | 📅 2026-09-01 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x main repository (including the Java API).
...
* [Apache ServiceComb Java Chassis](https://github.com/apache/servicecomb-java-chassis) ⭐ 1,942 | 🐛 230 | 🌐 Java | 📅 2026-07-01 - ServiceComb Java Chassis is a Software Development Kit (SDK) for rapid development of microservices in Java, providing service registration, service discovery, dynamic routing, and service management features.
...
* [openapi-generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,714 | 🐛 5,723 | 🌐 Java | 📅 2026-09-01 - OpenAPI Generator allows generation of API client libraries (SDK generation), server stubs, documentation and configuration automatically given an OpenAPI Spec (v2, v3).
...
* [vertx-redisques](https://github.com/swisspush/vertx-redisques) ⭐ 14 | 🐛 20 | 🌐 Java | 📅 2026-08-31 - A highly scalable redis-persistent queuing system for Vert.x.
...
* [Knative](https://github.com/knative/docs/tree/main/code-samples/community/serving/helloworld-vertx) ⭐ 5,083 | 🐛 42 | 🌐 HTML | 📅 2026-09-02 - An example application on how to use [Reactive Extensions Vert.x](https://github.com/vert-x3/vertx-rx) ⭐ 154 | 🐛 5 | 🌐 Java | 📅 2026-09-01 with [Knative](https://github.com/knative).
...
* [Contextual logging](https://github.com/reactiverse/reactiverse-contextual-logging) ⭐ 41 | 🐛 0 | 🌐 HTML | 📅 2026-08-24 - Mapped Diagnostic Context (MDC) that works with the Vert.x event-loop model.
