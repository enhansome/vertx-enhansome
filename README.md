...
[Vert.x](https://github.com/eclipse/vert.x) ⭐ 14,684 | 🐛 221 | 🌐 Java | 📅 2026-08-12.
...
* [Vert.x Web](https://github.com/vert-x3/vertx-web) ⭐ 1,151 | 🐛 150 | 🌐 Java | 📅 2026-08-10  <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Full featured web toolkit for Vert.x.
...
* Relational Databases
  * [Reactive SQL Client](https://github.com/eclipse-vertx/vertx-sql-client) ⭐ 912 | 🐛 76 | 🌐 Java | 📅 2026-08-10 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - High performance reactive SQL client.
  ...
  * [Exposed Vert.x SQL Client](https://github.com/huanshankeji/exposed-vertx-sql-client) ⭐ 10 | 🐛 16 | 🌐 Kotlin | 📅 2026-07-25 - Kotlin's [Exposed](https://github.com/JetBrains/Exposed) ⭐ 9,277 | 🐛 166 | 🌐 Kotlin | 📅 2026-08-12 on top of [Vert.x Reactive SQL Client](https://github.com/eclipse-vertx/vertx-sql-client) ⭐ 912 | 🐛 76 | 🌐 Java | 📅 2026-08-10.

* NoSQL Databases
  * [SirixDB](https://github.com/sirixdb/sirix/tree/master/bundles/sirix-rest-api) ⭐ 1,213 | 🐛 7 | 🌐 Java | 📅 2026-08-12 - Non-blocking SirixDB HTTP-server.
  ...
  * [Aerospike](https://github.com/dream11/vertx-aerospike-client) ⭐ 32 | 🐛 3 | 🌐 Java | 📅 2025-12-22 - Asynchronous and non-blocking API to interact with Aerospike server. Uses [AerospikeClient's](https://github.com/aerospike/aerospike-client-java) ⭐ 248 | 🐛 19 | 🌐 Java | 📅 2026-08-12 async commands internally and handles the result on the Vert.x Context.
...
* Messaging
  * [AMQP 1.0 - Kafka bridge](https://github.com/rhiot/amqp-kafka-bridge) ⭐ 338 | 🐛 15 | 🌐 Java | 📅 2026-08-11 - Bridge for sending/receiving messages to/from Apache Kafka using the AMQP 1.0 protocol.
  ...
  * [The White Rabbit](https://github.com/viartemev/the-white-rabbit) ⭐ 130 | 🐛 13 | 🌐 Kotlin | 📅 2026-08-12 - An asynchronous RabbitMQ (AMQP) client based on Kotlin coroutines.
...
* CNCF CloudEvents
  * [CloudEvents.io Java SDK](https://github.com/cloudevents/sdk-java) ⭐ 443 | 🐛 79 | 🌐 Java | 📅 2026-07-16 - Send and receive [CloudEvents](https://cloudevents.io/) using the [Vert.x HTTP Transport](https://github.com/cloudevents/sdk-java/blob/master/http/vertx/README.md) ⭐ 443 | 🐛 79 | 🌐 Java | 📅 2026-07-16 for CloudEvents.

## Middleware

* [Gateleen](https://github.com/swisspush/gateleen) ⭐ 84 | 🐛 45 | 🌐 Java | 📅 2026-08-05 - Middleware library based on Vert.x to build advanced JSON/REST communication servers.
...
* [Java](https://github.com/eclipse/vert.x) ⭐ 14,684 | 🐛 221 | 🌐 Java | 📅 2026-08-12 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x main repository (including the Java API).
...
* [Circuit Breaker](https://github.com/vert-x3/vertx-circuit-breaker) ⭐ 67 | 🐛 7 | 🌐 Java | 📅 2026-08-07 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Circuit Breaker" height="16px"> - Vert.x Circuit Breaker.
...
* [openapi-generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,666 | 🐛 5,727 | 🌐 Java | 📅 2026-08-12 - OpenAPI Generator allows generation of API client libraries (SDK generation), server stubs, documentation and configuration automatically given an OpenAPI Spec (v2, v3).
...
* [vertx-redisques](https://github.com/swisspush/vertx-redisques) ⭐ 14 | 🐛 21 | 🌐 Java | 📅 2026-08-11 - A highly scalable redis-persistent queuing system for Vert.x.
...
* [Knative](https://github.com/knative/docs/tree/main/code-samples/community/serving/helloworld-vertx) ⭐ 5,077 | 🐛 40 | 🌐 HTML | 📅 2026-08-11 - An example application on how to use [Reactive Extensions Vert.x](https://github.com/vert-x3/vertx-rx) ⭐ 155 | 🐛 5 | 🌐 Java | 📅 2026-08-07 with [Knative](https://github.com/knative).
...
* [Vert.x Markdown service](https://github.com/aesteve/vertx-markdown-service) ⭐ 6 | 🐛 1 | 🌐 Java | 📅 2015-11-15 - Example on how to use [service-proxy](https://github.com/vert-x3/vertx-service-proxy) ⭐ 70 | 🐛 19 | 🌐 Java | 📅 2026-08-07 with Gradle.
...
* [Vert.x Scheduler](https://github.com/zero88/vertx-scheduler) ⭐ 14 | 🐛 24 | 🌐 Java | 📅 2026-08-11 - A lightweight plugable scheduler based on plain Vert.x core without any external libs for scheduling with *cron-style* and *interval* timers with a detail *monitor* on both sync and async task.
