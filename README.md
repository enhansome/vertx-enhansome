...
[Vert.x](https://github.com/eclipse/vert.x) ⭐ 14,684 | 🐛 221 | 🌐 Java | 📅 2026-09-18.
...
* [Vert.x Maven plugin](https://github.com/reactiverse/vertx-maven-plugin) ⭐ 81 | 🐛 9 | 🌐 Java | 📅 2026-09-18
...
* [Vert.x Web](https://github.com/vert-x3/vertx-web) ⭐ 1,150 | 🐛 150 | 🌐 Java | 📅 2026-09-18  <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Full featured web toolkit for Vert.x.
...
* [Irked](https://github.com/GreenfieldTech/irked) ⭐ 36 | 🐛 0 | 🌐 Java | 📅 2026-09-18 - Annotations-based configuration for Vert.x Web, with a controller framework and expressive APIs for REST.
...
* [Vert.x Auth SQL](https://github.com/eclipse-vertx/vertx-auth) ⭐ 175 | 🐛 44 | 🌐 Java | 📅 2026-09-18  <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x authentication/authorisation based on the Vert.x SQL client and a relational database.

* [Vert.x Auth JWT](https://github.com/eclipse-vertx/vertx-auth/tree/master/vertx-auth-jwt) ⭐ 175 | 🐛 44 | 🌐 Java | 📅 2026-09-18  <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x Authorisation based on JSON Web Tokens.

* [Vert.x Auth htdigest](https://github.com/eclipse-vertx/vertx-auth/tree/master/vertx-auth-htdigest) ⭐ 175 | 🐛 44 | 🌐 Java | 📅 2026-09-18  <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x Authorisation/Authentication based on [Apache htdigest](https://httpd.apache.org/docs/2.4/programs/htdigest.html).

* [Vert.x Auth OAuth2](https://github.com/eclipse-vertx/vertx-auth/tree/master/vertx-auth-oauth2) ⭐ 175 | 🐛 44 | 🌐 Java | 📅 2026-09-18 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x Authorisation/Authentication based on [OAuth 2](https://oauth.net/2/).
...
* [Vert.x-Pac4j](https://github.com/pac4j/vertx-pac4j) ⭐ 135 | 🐛 2 | 🌐 Java | 📅 2026-09-19 - Vert.x authentication/authorisation implemented using [pac4j](http://www.pac4j.org/).
...
* Relational Databases
  * [Reactive SQL Client](https://github.com/eclipse-vertx/vertx-sql-client) ⭐ 912 | 🐛 75 | 🌐 Java | 📅 2026-09-18 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - High performance reactive SQL client.
  ...
  * [JDBC](https://github.com/vert-x3/vertx-jdbc-client) ⭐ 131 | 🐛 31 | 🌐 Java | 📅 2026-09-18 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Asynchronous interface around a JDBC datasource.
  ...
  * [Exposed Vert.x SQL Client](https://github.com/huanshankeji/exposed-vertx-sql-client) ⭐ 11 | 🐛 16 | 🌐 Kotlin | 📅 2026-09-11 - Kotlin's [Exposed](https://github.com/JetBrains/Exposed) ⭐ 9,287 | 🐛 167 | 🌐 Kotlin | 📅 2026-09-18 on top of [Vert.x Reactive SQL Client](https://github.com/eclipse-vertx/vertx-sql-client) ⭐ 912 | 🐛 75 | 🌐 Java | 📅 2026-09-18.

* NoSQL Databases
  * [SirixDB](https://github.com/sirixdb/sirix/tree/master/bundles/sirix-rest-api) ⭐ 1,218 | 🐛 3 | 🌐 Java | 📅 2026-09-20 - Non-blocking SirixDB HTTP-server.
  ...
  * [Aerospike](https://github.com/dream11/vertx-aerospike-client) ⭐ 32 | 🐛 3 | 🌐 Java | 📅 2025-12-22 - Asynchronous and non-blocking API to interact with Aerospike server. Uses [AerospikeClient's](https://github.com/aerospike/aerospike-client-java) ⭐ 248 | 🐛 27 | 🌐 Java | 📅 2026-09-19 async commands internally and handles the result on the Vert.x Context.
...
* Mail
  * [SMTP](https://github.com/vert-x3/vertx-mail-client) ⭐ 40 | 🐛 15 | 🌐 Java | 📅 2026-09-18 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Async SMTP client.
...
* Netflix - Hystrix
  * [Hystrix Metrics Stream](https://github.com/kennedyoliveira/hystrix-vertx-metrics-stream.git) ⭐ 15 | 🐛 2 | 🌐 Java | 📅 2016-10-03 - Emits metrics for Hystrix Dashboard from a Vert.x application with [Hystrix](https://github.com/Netflix/Hystrix) ⭐ 24,483 | 🐛 58 | 🌐 Java | 📅 2025-12-17.
...
* [Gateleen](https://github.com/swisspush/gateleen) ⭐ 84 | 🐛 42 | 🌐 Java | 📅 2026-09-18 - Middleware library based on Vert.x to build advanced JSON/REST communication servers.
...
* [Java](https://github.com/eclipse/vert.x) ⭐ 14,684 | 🐛 221 | 🌐 Java | 📅 2026-09-18 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x main repository (including the Java API).
...
* [Go](https://github.com/jponge/vertx-go-tcp-eventbus-bridge) ⭐ 33 | 🐛 0 | 🌐 Go | 📅 2018-03-15- Event bus client for Go-lang using the [TCP-based protocol](https://github.com/vert-x3/vertx-tcp-eventbus-bridge) ⭐ 54 | 🐛 10 | 🌐 Java | 📅 2026-09-18.
...
* [Python](https://github.com/jaymine/TCP-eventbus-client-Python) ⭐ 12 | 🐛 2 | 🌐 Python | 📅 2016-08-05 - Event bus client for Python using the [TCP-based protocol](https://github.com/vert-x3/vertx-tcp-eventbus-bridge) ⭐ 54 | 🐛 10 | 🌐 Java | 📅 2026-09-18.
* [Smalltalk](https://github.com/mumez/VerStix) ⭐ 10 | 🐛 0 | 🌐 Smalltalk | 📅 2017-07-03- Event bus client for [Pharo Smalltalk](http://pharo.org/) using the [TCP-based protocol](https://github.com/vert-x3/vertx-tcp-eventbus-bridge) ⭐ 54 | 🐛 10 | 🌐 Java | 📅 2026-09-18.
...
* [C#](https://github.com/jaymine/TCP-eventbus-client-C-Sharp) ⭐ 6 | 🐛 2 | 🌐 C# | 📅 2016-12-16 - Event bus client for C# using the [TCP-based protocol](https://github.com/vert-x3/vertx-tcp-eventbus-bridge) ⭐ 54 | 🐛 10 | 🌐 Java | 📅 2026-09-18.
* [Swift](https://github.com/tobias/vertx-swift-eventbus) ⭐ 5 | 🐛 6 | 🌐 Swift | 📅 2018-04-24 - Event bus client for [Apple's Swift](https://swift.org) using the [TCP-based protocol](https://github.com/vert-x3/vertx-tcp-eventbus-bridge) ⭐ 54 | 🐛 10 | 🌐 Java | 📅 2026-09-18.
* [C](https://github.com/jaymine/TCP-eventbus-client-C) ⭐ 4 | 🐛 0 | 🌐 C | 📅 2016-08-09 - Event bus client for C99 using the [TCP-based protocol](https://github.com/vert-x3/vertx-tcp-eventbus-bridge) ⭐ 54 | 🐛 10 | 🌐 Java | 📅 2026-09-18.
...
* [Hazelcast Cluster Manager](https://github.com/vert-x3/vertx-hazelcast) ⭐ 83 | 🐛 2 | 🌐 Java | 📅 2026-09-18 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Hazelcast cluster manager.
* [Zookeeper Cluster Manager](https://github.com/vert-x3/vertx-zookeeper) ⭐ 75 | 🐛 31 | 🌐 Java | 📅 2026-09-18 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Zookeeper cluster manager.
* [Ignite Cluster Manager](https://github.com/vert-x3/vertx-ignite) ⭐ 34 | 🐛 3 | 🌐 Java | 📅 2026-09-18 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Ignite cluster manager.
* [Consul Cluster Manager](https://github.com/reactiverse/consul-cluster-manager) ⭐ 20 | 🐛 11 | 🌐 Java | 📅 2023-12-05 - Consul cluster manager.
* [Infinispan Cluster Manager](https://github.com/vert-x3/vertx-infinispan) ⭐ 16 | 🐛 5 | 🌐 Java | 📅 2026-09-18 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Infinispan cluster manager.
...
* [Service Discovery - Kubernetes](https://github.com/vert-x3/vertx-service-discovery) ⭐ 121 | 🐛 14 | 🌐 Java | 📅 2026-09-18 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Service Discovery - Kubernetes" height="16px"> - [Kubernetes](http://kubernetes.io/) extension to Vert.x Service Discovery.
* [Service Discovery - Redis backend](https://github.com/vert-x3/vertx-service-discovery) ⭐ 121 | 🐛 14 | 🌐 Java | 📅 2026-09-18 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Service Discovery - Redis backend" height="16px"> - [Redis](http://redis.io/) storage backend for Vert.x Service Discovery.
...
* [Circuit Breaker](https://github.com/vert-x3/vertx-circuit-breaker) ⭐ 67 | 🐛 6 | 🌐 Java | 📅 2026-09-18 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Circuit Breaker" height="16px"> - Vert.x Circuit Breaker.
...
* [Vert.x JUnit5](https://github.com/vert-x3/vertx-junit5) ⭐ 43 | 🐛 11 | 🌐 Java | 📅 2026-09-18 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Async unit testing for Vert.x with junit5.
* [Vert.x Unit](https://github.com/vert-x3/vertx-unit) ⭐ 33 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-18 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Async polyglot unit testing for Vert.x.
* [Vert.x WireMongo](https://github.com/noenv/vertx-wiremongo) ⭐ 14 | 🐛 0 | 🌐 Java | 📅 2026-09-18 - Lightweight MongoDB mocking for Vert.x

## Development Tools

* [openapi-generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,752 | 🐛 5,750 | 🌐 Java | 📅 2026-09-20 - OpenAPI Generator allows generation of API client libraries (SDK generation), server stubs, documentation and configuration automatically given an OpenAPI Spec (v2, v3).
...
* [Vert.x Stack](https://github.com/vert-x3/vertx-stack) ⭐ 123 | 🐛 8 | 🌐 Java | 📅 2026-09-18 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - Vert.x + the endorsed modules.

## Examples

* [Knative](https://github.com/knative/docs/tree/main/code-samples/community/serving/helloworld-vertx) ⭐ 5,091 | 🐛 54 | 🌐 HTML | 📅 2026-09-10 - An example application on how to use [Reactive Extensions Vert.x](https://github.com/vert-x3/vertx-rx) ⭐ 154 | 🐛 5 | 🌐 Java | 📅 2026-09-18 with [Knative](https://github.com/knative).
* [Vert.x examples](https://github.com/vert-x3/vertx-examples) ⭐ 3,578 | 🐛 45 | 🌐 Java | 📅 2026-09-18 <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" height="16px"> - The official Vert.x examples including web examples, how to use the official database clients, etc.
...
* [Vert.x Markdown service](https://github.com/aesteve/vertx-markdown-service) ⭐ 6 | 🐛 1 | 🌐 Java | 📅 2015-11-15 - Example on how to use [service-proxy](https://github.com/vert-x3/vertx-service-proxy) ⭐ 70 | 🐛 18 | 🌐 Java | 📅 2026-09-18 with Gradle.
